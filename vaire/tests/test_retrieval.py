...
class TestQueryEntityExtraction:
    ...
    def test_extracts_file_paths(self):
        entities = _extract_query_entities("Check vaire/server.py for bugs")
        assert "vaire/server.py" in entities
    ...
    def test_extracts_dotted_names(self):
        entities = _extract_query_entities("Import from vaire.storage module")
        assert "vaire.storage" in entities

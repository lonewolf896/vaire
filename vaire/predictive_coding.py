...
information that violates expectations. For Vaire, the "generative model"
...
class PredictiveCodingGate:
    ...
    def get_directory_model(self, directory: str) -> dict:
        """Build summary of what Vaire 'knows' about a directory.
        ...
        # Average heat
        avg_heat = sum(m.get("heat", 0.0) for m in memories) / memory_count

...
class EmbeddingEngine:
    ...
    # Shared across all EmbeddingEngine instances in the same process so the
    # model is only loaded from disk once regardless of how many engines are
    # created (e.g. one per test in the test suite).
    _model_cache: dict[str, object] = {}

    def __init__(self, model_name: str = "all-MiniLM-L6-v2") -> None:
        self.model_name = model_name
        self._model = EmbeddingEngine._model_cache.get(model_name)
